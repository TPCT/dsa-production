 ...
 * @method static \Illuminate\Database\Eloquent\Builder|SliderLang whereImageId($value)
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|SliderLang whereSecondTitle($value)
 * @mixin \Eloquent
 */
class SliderSlideLang extends Model implements Auditable
{
    ...
    protected $table = "slider_slide_langs";
