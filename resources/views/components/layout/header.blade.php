            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    @foreach($menu->links as $link)
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{\App\Helpers\Utilities::getActiveLink($link->link)}}" aria-current="page" href="{{$link->link}}"
                            >{{$link->title}}</a
                            >
                        </li>
                    @endforeach
                ...
                <a id="lang-icon" href="{{route(request()->route()->getName() ?: "site.index", array_merge(request()->route()->parameters(), ['locale' => app()->getLocale() == "ar" ? "en" : "ar"], request()->query()))}}" class="lang d-flex align-items-center gap-2 text-black fw-bold">
                    @if (app()->getLocale() == "en")
